package como.sekolah.myintentapp;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnMoveActivity = findViewById(R.id.bn_move_activity);
        ...
        btnForResult =  findViewById(R.id.btn_move_for_result);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.btn_move_for_result:
                Intent moveResultIntent = new Intent(MainActivity.this, MoveForResultActivity.class);
