...
//    untuk mengetahui berapa banyak item yang ingin ditampilkan
    @Override
    public int getCount() {
        return heroes.size();
    }
...
//    get view di gunakan untuk memanggil layout item yang sudah di buatdan melakukan manipulasi setiap ompnennya di class View Holder
    @Override
