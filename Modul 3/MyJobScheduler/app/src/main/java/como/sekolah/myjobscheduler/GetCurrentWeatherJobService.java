package como.sekolah.myjobscheduler;
...
//    API dari openweathermap
    final String APP_ID = "060f94916f88272d2c3376ff7c97df20";
    ...
    private void getCurrentWeather(final JobParameters job){
        ...
        client.get(url, new AsyncHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                ...
                Log.d(TAG, result);
                try {
//                    Kode di bawah akan memparsing respons menjadi sebuah obyek
...
//                    Kode di bawah digunakan untuk memformat tampilan agar hanya ada dua nilai dibelakang koma.
    ...
    private void showNotification(Context context, String title, String message, int notifId) {
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(context, CHANNEL_ID)
                ...
                .setSmallIcon(R.drawable.baseline_replay_black_48dp)
