...
import como.sekolah.favoriteapp.adapter.FavoriteTVShowAdapter;
import como.sekolah.favoriteapp.db.DatabaseTVShowContract;
import como.sekolah.favoriteapp.entity.FavoriteTVShow;
import como.sekolah.favoriteapp.helper.TVShowMappingHelper;
...
//            new FavoriteTvShowFragment.LoadTvAsync(context, (LoadTvCallback) context).execute();
        }
    }
}
