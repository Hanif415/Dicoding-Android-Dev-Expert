...
public class FavoriteBannerWidget extends AppWidgetProvider {
    ...
    public static final String TOAST_ACTION = "como.sekolah.submission4.TOAST_ACTION";
    public static final String EXTRA_ITEM = "como.sekolah.submission4.EXTRA_ITEM";
